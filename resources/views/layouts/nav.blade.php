            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-12">
                   ...
                   <a href="{{url('/')}}" class="my-logo">
                       <img class="logo-two" src="{{asset($settings['logo']) }}" alt="logo">
                   </a>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                  ...
                  <ul id="main-menu" class="nav-menu">
                      ...
                      <li class="nav-item @if(request()->path() == 'terms-condition') active @endif">
                          <a href="{{url('terms-condition')}}" class="nav-link">
                              Terms of Use
                          </a>                                                    
                          
                      </li>
                      <li class="nav-item @if(request()->path() == 'support') active @endif">
