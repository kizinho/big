                            ...
                            <div class="info-header table-cell">
                                <div class="inner-banner" >
                                    ...
                                    <div class="banner-btn">
                                        ...
                                        <a href="<?php echo e(url('login')); ?>" data-lity class="play-video btn-one"><div class="play"><i class="fa fa-user" style="color:#fff!important"></i> </div><span class="hide-on-large-only show-on-small">Login </span> <span  style="color:#fff!important">Login</span></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="owl-carousel about-carousel">
                            <div class="owl-item">
                                ...
                                <p class="mb-40">
                                    ...
                                    <br/><br/>
                                    <a href="<?php echo e(url('about-us')); ?>"><button class="btn btn-primary" style="background-color: #ff7e00!important;color:#fff!important">Read more </button></a>
...
<!--body content end--> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\naijacrawl soft\new_ik_btc\greengold\resources\views/welcome.blade.php ENDPATH**/ ?>